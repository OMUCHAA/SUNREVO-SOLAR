<template>
  <footer class="relative bg-blue-950 backdrop-blur-md text-white pt-10">
    <div
      class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left"
    >
      <!-- Company Info -->
      <div>
        ...
        <div class="flex md:justify-start justify-center mb-4">
          <img src="/images/sunrevo.jpeg" alt="Company-Logo" class="h-12" />
        </div>
        <p class="text-blue-300">
          SunRevo Power provides affordable, reliable, and eco-friendly solar energy
          solutions for homes and businesses across Kenya.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2 text-blue-300">
          ...
          <li>
            <router-link to="/services" class="hover:text-white transition"
              >Services</router-link
            >
          </li>
          <li>
            <router-link to="/projects" class="hover:text-white transition"
      ...
      <div>
        ...
        <p class="text-blue-500">info@sunrevo.co.ke</p>
      </div>
    </div>
    <div
      class="border-t border-white/20 py-4 mt-4 text-center text-blue-200 text-base bg-blue-950"
    >
